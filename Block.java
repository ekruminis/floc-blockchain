...
public class Block implements Serializable {
    ...
    /** Sets the transactions of the block inside a TreeSet */
    public void setTransactions(TreeSet<Transaction> txList) {
        this.transactions = txList;
    }

    /** Returns the transactions of the block inside a TreeSet */
